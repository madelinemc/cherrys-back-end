...
ActiveRecord::Schema.define(version: 2021_01_31_204424) do
  ...
  create_table "scoops", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["flavor_id"], name: "index_scoops_on_flavor_id"
    t.index ["order_id"], name: "index_scoops_on_order_id"
  end

  create_table "topping_types", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "toppings", force: :cascade do |t|
    t.bigint "topping_type_id", null: false
    t.bigint "order_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
